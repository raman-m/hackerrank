namespace RamanM.HackerRank.DataStructures.LinkedLists.InsertANodeAtTheHeadOfALinkedList;
...
public class Solution
{
    ...
    public static void Main(string[] args)
    {
        ...
        PrintSinglyLinkedList(llist.head, Environment.NewLine, textWriter);
